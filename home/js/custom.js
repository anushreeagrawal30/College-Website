    ...
    THEMEMASCOT.initialize = {
        ...
        TM_preLoaderClickDisable: function() {
            ...
            $preloader.children('#disable-preloader').on('click', function(e) {
                // $preloader.fadeOut();
				$("#no-iitd-scroll").attr("id", "iitd-scroll");
				// $preloader.addClass('slide-left');
			...
			$('#start-tour').on('click', function() {
				$("#no-iitd-scroll").attr("id", "iitd-scroll");
				$preloader2.addClass('slide-right');
			...
			// var $preloader2 = $('#preloader2');
            // $preloader2.children('#start-tour').on('click', function(e) {
				// $("#no-iitd-scroll").attr("id", "iitd-scroll");
				// $preloader2.addClass('slide-right');
				 // setTimeout(tourStart, 300);
				 // $("#preloader2").remove();
			...
			// $preloader2.children('#skip-tour').on('click', function(e) {
				// $("#no-iitd-scroll").attr("id", "iitd-scroll");
				// localStorage.firstVisit = "1";
			...
			// var $skip_voice = $('#voice-bg');
			// $skip_voice.children('#skip-voice').on('click', function(e) {
				// $("#no-csc-scroll").attr("id", "csc-scroll");
				// localStorage.FirstVoiceVisit = "1";
				// $skip_voice.addClass('slide-right');
				// $skip_voice.remove();
                // return false;
            // });
        },
        ...
        TM_preLoaderOnLoad: function() {
            ...
            if( $preloader.length > 0 ) {
				if (localStorage.firstVisit && localStorage.disableVoice) {
					$("#no-iitd-scroll").attr("id", "iitd-scroll");
				}
				else if (!localStorage.firstVisit && localStorage.voiceNoSupport) {
					//
				}
				else {
					$("#no-iitd-scroll").attr("id", "iitd-scroll"); // Temp till voice
					tourTyped();
				}
                // $preloader.addClass('slide-left');
                $preloader.delay(600).fadeOut('slow');
